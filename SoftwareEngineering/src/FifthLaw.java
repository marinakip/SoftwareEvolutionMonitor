...
public class FifthLaw extends JFrame {
	...
	public FifthLaw() {
		...
		JLabel lblthLehmansLaw = new JLabel("5th Lehman's law evaluation");
		...
		JLabel lblIsTheth = new JLabel("Is the 5th Lehman law valid?");
