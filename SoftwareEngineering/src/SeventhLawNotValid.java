...
public class SeventhLawNotValid extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SeventhLawNotValid frame = new SeventhLawNotValid();
	...
	public SeventhLawNotValid() {
		...
		JLabel lblWereFoundValid = new JLabel("either one of them was not found valid. As a result, the 7th Lehman's law is NOT VALID.");
		lblWereFoundValid.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblWereFoundValid.setBounds(94, 173, 568, 14);
