...
public class SixthLaw extends JFrame {
	...
	public SixthLaw() {
		...
		JLabel lblthLehmansLaw = new JLabel("6th Lehman's law evaluation");
		...
		JLabel lblOperationsNumber = new JLabel("Operations number");
		lblOperationsNumber.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblOperationsNumber.setBounds(131, 51, 136, 14);
		contentPane.add(lblOperationsNumber);
		
		JLabel lblDataStructuresNumber = new JLabel("Data Structures number");
		lblDataStructuresNumber.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblDataStructuresNumber.setBounds(381, 51, 143, 14);
		contentPane.add(lblDataStructuresNumber);
		
		JLabel lblIsTheth = new JLabel("Is the 6th Lehman law valid?");
