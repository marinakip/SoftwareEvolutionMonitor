...
public class ErrorEvaluationSecondLaw extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ErrorEvaluationSecondLaw frame = new ErrorEvaluationSecondLaw();
	 ...
	 * Create the frame.
	 */
	public ErrorEvaluationSecondLaw() {
		...
		JLabel lblNewLabel = new JLabel("You haven't evaluated the 2nd law.");
		...
		lblNewLabel_1.setIcon(new ImageIcon(ErrorEvaluationSecondLaw.class.getResource("/javax/swing/plaf/metal/icons/ocean/error.png")));
